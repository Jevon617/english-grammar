...
动词该采用单数还是复数，当然是视主语而定。英语句子的主语必须是名词，包括名词短语、代词、动名词、不定词短语、以及名词从句。以占大宗的名词短语来看，名词短语当中的名词有些字只有单数形、有些字只有复数形。有些字看起来像单数却要用复数动词、有些是看起来像复数却要用单数动词、还有一些则是采用单数复数动词皆可。
...
英语中像是 trousers「长裤」、glasses「眼镜」、scissors「剪刀」、pliers「钳子」、shoes「鞋子」这些名词，习惯都采复数形。请比较下列用法：
...
如果主语是动名词、不定词短语、名词从句等语法结构，那么动词通常要用单数，例如：
